 ...
 */
public class MyCelebrityRecyclerViewAdapter extends RecyclerView.Adapter<MyCelebrityRecyclerViewAdapter.ViewHolder> {

    private final List<Celebrity> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyCelebrityRecyclerViewAdapter(List<Celebrity> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
